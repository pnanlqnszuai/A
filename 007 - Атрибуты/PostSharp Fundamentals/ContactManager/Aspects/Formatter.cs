      ...
      /// <summary>
            ...
            object[] invocationParameters )
        {
            string[] parts = new string[4]
                                 {
                                     typeIsGeneric
                                         ? Formatter.FormatString( typeFormat, method.DeclaringType.GetGenericArguments() )
                                         : typeFormat,
                                     methodIsGeneric
                                         ? Formatter.FormatString( methodFormat, method.GetGenericArguments() )
                                         : methodFormat,
                                     instance == null ? "" : string.Format( "{{{0}}}", instance ),
                                     Formatter.FormatString( parameterFormat, invocationParameters )
                                 };
